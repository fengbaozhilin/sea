...
&nbsp;&nbsp;回复内容：<input name="msg1b"  size="100"  value="<?php echo msg1b;?>">
</td>
</tr>
<tr>
<td width="80%" align="left" height="30" class="td_border">
【2】关键词:<input name="msg2a"  size="10"  value="<?php echo msg2a;?>">
&nbsp;&nbsp;回复内容：<input name="msg2b"  size="100"  value="<?php echo msg2b;?>">
</td>
</tr>
<tr>
<td width="80%" align="left" height="30" class="td_border">
【3】关键词:<input name="msg3a"  size="10"  value="<?php echo msg3a;?>">
&nbsp;&nbsp;回复内容：<input name="msg3b"  size="100"  value="<?php echo msg3b;?>">
</td>
</tr>
<tr>
<td width="80%" align="left" height="30" class="td_border">
【4】关键词:<input name="msg4a"  size="10"  value="<?php echo msg4a;?>">
&nbsp;&nbsp;回复内容：<input name="msg4b"  size="100"  value="<?php echo msg4b;?>">
</td>
</tr>
<tr>
<td width="80%" align="left" height="30" class="td_border">
【5】关键词:<input name="msg5a"  size="10"  value="<?php echo msg5a;?>">
&nbsp;&nbsp;回复内容：<input name="msg5b"  size="100"  value="<?php echo msg5b;?>">
</td>
</tr>
