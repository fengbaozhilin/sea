...
function expendPlayArea(i,optionStr,type){
	...
	var n=i-1,m=i+1
	var sparkStr=(type==1)?"":""
	var sparkStr2=(type==1)?"&nbsp;&nbsp;<font color='#8B7765'>格式：集数$播放地址$播放器，每行一集，正常情况下无需手动校正，系统会自动进行</font>":""
...
function expendDownArea(i,optionStr,type){
	...
	optionStr=unescape(optionStr)
	var n=i-1,m=i+1
	var sparkStr=(type==1)?"&nbsp;&nbsp;<font color='#8B7765' style='position:absolute;left: 280px; line-height:23px;white-space:nowrap' >格式：集数$播放地址$播放器，每行一集，正常情况下无需手动校正，系统会自动进行</font>":""
